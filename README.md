...
<img src="https://img.shields.io/badge/BaseOkHttp-2.0.6-green.svg" alt="BaseOkHttp">
</a>
<a href="https://bintray.com/myzchh/maven/BaseOkHttp/2.0.6/link">
...
在dependencies{}中添加引用：
```
implementation 'com.kongzue.baseokhttp:baseokhttp:2.0.6'
```
